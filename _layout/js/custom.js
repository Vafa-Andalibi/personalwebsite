(function ($) {
	...
	$(document).ready(function () {
		...
		if ($('#back-to-top2').length) {
			var scrollTrigger2 = 150, // px
				backToTop2 = function () {
					/* window.alert("sometext");*/
					var scrollTop2 = $(window).scrollTop();
					if (scrollTop2 > scrollTrigger2) {
		...
		// if ($('#back-to-top3').length) {
		// 	var scrollTrigger3 = 3200 , // px
		// 		backToTop3 = function () {
		// 			var scrollTop3 = $(window).scrollTop();
		// 			if (scrollTop3 > scrollTrigger3) {

		// 				$('#back-to-top3').addClass('show');
		// 			} else {
		// 				$('#back-to-top3').removeClass('show');
		// 			}
		// 		};
		// 	backToTop3();
		// 	$(window).on('scroll', function () {
		...
		var psst_already_shown = false;
		window.addEventListener("scroll", function () {

			var elementTarget = document.getElementById("just-before-skills");
			if (window.scrollY > (elementTarget.offsetTop + elementTarget.offsetHeight)) {
				if (!psst_already_shown == true) {
					setTimeout(function () {
						$('#back-to-top3').addClass('show');
					}, 2500);
